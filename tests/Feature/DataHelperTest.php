...
class DataHelperTest extends TestCase
{
    ...
    public function test_data_only_with_key()
    {
        $data['key_value']['key'] = 'test_key';
        $data['key_value']['value'] = 'test_value';
        $data['key_value']['type'] = 'number';
    ...
    public function test_data_only_with_string()
    {
        $data['key_value']['key'] = 'test_key';
        $data['key_value']['value'] = 'test_value';
        $data['key_value']['type'] = 'number';
        $result = data_only($data, 'key_value.key'
